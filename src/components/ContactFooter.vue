...
<template>
    <div>
        <h3 class="serif text-white text-5xl mb-20" :class="isLg ? 'lg:ml-[7em]' : 'md:ml-[7em]'">Contact</h3>
        <ul class="text-white text-2xl sans">
            <li class="mb-15 w-fit" :class="isLg ? 'lg:ml-[10em]' : 'md:ml-[10em]'" v-on:mouseover="showEmail('on')"
